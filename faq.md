...
Players are encouraged to attend the weekly Wednesday session where possible. Saturday game attendance is a firmer expectation because it helps build consistency and team rhythm.
...
Players should arrive with shin pads, boots, long socks and a water bottle. For home practice, a size `2` or `3` ball is ideal.
